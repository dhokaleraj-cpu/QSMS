# QCMS Mobile v0.2.3 — Samsung internal test
...
1. Deploy QCMS v4.14.42 with the supplied updater. The Git push includes the Android workflow.
...
5. Transfer QCMS_Mobile_v0.2.3_TEST.apk to your Samsung or download/extract it there.
...
writes the built, signature-verified APK to ~/Downloads/QCMS_Mobile_v0.2.3_TEST.apk.
