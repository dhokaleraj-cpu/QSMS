# QCMS Mobile v0.1.2 — Samsung internal test
...
1. Deploy QCMS v4.14.34 with the supplied updater. The Git push includes the Android workflow.
...
4. Under Artifacts, download QCMS-Mobile-v0.1.2-TEST-APK. Extract that ZIP.
5. Transfer QCMS_Mobile_v0.1.2_TEST.apk to your Samsung or download/extract it there.
...
writes the built, signature-verified APK to ~/Downloads/QCMS_Mobile_v0.1.2_TEST.apk.
