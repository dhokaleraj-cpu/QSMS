# QCMS Mobile v0.2.1 — Samsung internal test
...
5. Transfer QCMS_Mobile_v0.2.1_TEST.apk to your Samsung or download/extract it there.
...
writes the built, signature-verified APK to ~/Downloads/QCMS_Mobile_v0.2.1_TEST.apk.
