...
\n    /* QCMS 4.10.4 — premium authentication workspace */\n    .stApp:has([class*="st-key-qcms_login_shell"]),\n    div[data-testid="stAppViewContainer"]:has([class*="st-key-qcms_login_shell"]){\n      background:\n        radial-gradient(circle at 12% 18%,rgba(20,105,168,.14) 0,rgba(20,105,168,0) 28%),\n        radial-gradient(circle at 88% 78%,rgba(15,118,110,.11) 0,rgba(15,118,110,0) 27%),\n        linear-gradient(145deg,#EAF3FA 0%,#F8FBFD 48%,#EDF5FA 100%)!important;\n    }\n    [class*="st-key-qcms_login_shell"]{\n      max-width:1180px!important;margin:4.2vh auto 1.2rem!important;padding:16px!important;\n      background:rgba(255,255,255,.88)!important;border:1px solid #BCD2E2!important;border-radius:24px!important;\n      box-shadow:0 24px 60px rgba(6,50,90,.16)!important;backdrop-filter:blur(10px);overflow:visible!important;\n    }\n    [class*="st-key-qcms_login_shell"]>div[data-testid="stVerticalBlock"]{gap:.35rem!important;}\n    .qcms-login-hero{min-height:560px;border-radius:18px;padding:38px 38px 30px;position:relative;overflow:hidden;color:#fff;\n      background:linear-gradient(145deg,#062F5B 0%,#07477F 48%,#0B7CB8 100%);box-shadow:0 12px 30px rgba(5,53,96,.20);}\n    .qcms-login-hero:before{content:"";position:absolute;width:330px;height:330px;border-radius:50%;right:-150px;top:-120px;background:rgba(255,255,255,.08);}\n    .qcms-login-hero:after{content:"";position:absolute;width:250px;height:250px;border-radius:50%;left:-120px;bottom:-120px;background:rgba(67,214,190,.09);}\n    .qcms-login-logo-wrap{position:relative;z-index:1;display:flex;align-items:center;justify-content:center;width:186px;height:76px;background:#fff;border-radius:14px;padding:9px 14px;box-shadow:0 5px 16px rgba(0,0,0,.16);margin-bottom:24px;}\n    .qcms-login-logo{width:166px;max-height:58px;object-fit:contain}.qcms-login-logo-fallback{font-size:32px;font-weight:950;color:#0B416F}\n    .qcms-login-eyebrow{position:relative;z-index:1;font-size:12px;font-weight:900;letter-spacing:.17em;color:#BFE5FF;margin-bottom:9px;}\n    .qcms-login-title{position:relative;z-index:1;font-size:34px;font-weight:950;line-height:1.03;letter-spacing:.015em;color:#fff;margin-bottom:14px;text-shadow:0 2px 4px rgba(0,0,0,.14);}\n    .qcms-login-subtitle{position:relative;z-index:1;max-width:520px;font-size:14px;font-weight:650;line-height:1.45;color:#D9EEFC;margin-bottom:25px;}\n    .qcms-login-feature-list{position:relative;z-index:1;display:grid;gap:10px;margin:0 0 22px;}\n    .qcms-login-feature{display:flex;gap:12px;align-items:flex-start;padding:10px 12px;border:1px solid rgba(255,255,255,.16);border-radius:11px;background:rgba(255,255,255,.075);}\n    .qcms-login-feature>span{display:flex;align-items:center;justify-content:center;flex:0 0 31px;width:31px;height:31px;border-radius:8px;background:rgba(255,255,255,.14);font-size:10px;font-weight:950;color:#fff;}\n    .qcms-login-feature b{display:block;font-size:12px;font-weight:900;color:#fff;line-height:1.25}.qcms-login-feature small{display:block;font-size:10px;font-weight:550;color:#D5E9F7;margin-top:3px;line-height:1.35;}\n    .qcms-login-badges{position:relative;z-index:1;display:flex;flex-wrap:wrap;gap:7px;margin-top:4px}.qcms-login-badges span{padding:4px 8px;border-radius:999px;border:1px solid rgba(255,255,255,.23);background:rgba(255,255,255,.10);font-size:8px;font-weight:900;letter-spacing:.06em;color:#EAF7FF;}\n    .qcms-login-version{position:relative;z-index:1;margin-top:18px;font-size:9px;font-weight:750;color:#B9DBEF;}\n    [class*="st-key-qcms_login_panel"]{padding:16px 12px 10px!important;overflow:visible!important;}\n    [class*="st-key-qcms_login_panel"] div[data-testid="stForm"]{border:0!important;padding:.45rem 0 .2rem!important;box-shadow:none!important;background:transparent!important;}\n    .qcms-login-panel-head{display:flex;gap:13px;align-items:center;margin:5px 0 20px;}\n    .qcms-login-lock{display:flex;align-items:center;justify-content:center;flex:0 0 42px;width:42px;height:42px;border-radius:12px;background:linear-gradient(145deg,#E4F2FC,#D7ECFA);border:1px solid #AFD0E7;color:#0A68A7;font-size:20px;font-weight:950;}\n    .qcms-login-welcome{font-size:24px;font-weight:950;color:#0B2D4D;line-height:1.1;margin-bottom:5px}.qcms-login-help{font-size:11px;font-weight:600;line-height:1.4;color:#617486;max-width:410px;}\n    [class*="st-key-qcms_login_panel"] label[data-testid="stWidgetLabel"] p{font-size:12px!important;font-weight:900!important;color:#163A59!important;}\n    [class*="st-key-qcms_login_panel"] [data-baseweb="input"]{min-height:44px!important;border-radius:9px!important;border-color:#AFC4D5!important;background:#FBFDFF!important;}\n    [class*="st-key-qcms_login_panel"] [data-baseweb="input"]:focus-within{border-color:#0C75B9!important;box-shadow:0 0 0 3px rgba(12,117,185,.10)!important;}\n    [class*="st-key-qcms_login_panel"] .stFormSubmitButton>button{min-height:46px!important;border-radius:9px!important;background:linear-gradient(100deg,#075087,#0C80C9)!important;border-color:#075087!important;box-shadow:0 5px 12px rgba(7,80,135,.18)!important;font-weight:950!important;}\n    [class*="st-key-qcms_login_panel"] details[data-testid="stExpander"]{background:#F7FAFC!important;border:1px solid #D0DEE8!important;border-radius:9px!important;margin-top:.55rem!important;}\n    [class*="st-key-qcms_login_panel"] details[data-testid="stExpander"] summary{font-weight:850!important;color:#21445F!important;}\n    .qcms-login-security{margin:7px 0 5px;padding:8px 10px;border-radius:8px;background:#F0F7FC;border-left:4px solid #0D78B6;color:#536A7C;font-size:9.5px;font-weight:650;line-height:1.35;}\n    .qcms-login-preview-label{font-size:8px;font-weight:900;letter-spacing:.12em;color:#768B9B;margin:15px 0 5px;text-align:center;}\n    [class*="st-key-qcms_login_panel"] .stButton>button{min-height:39px!important;border-radius:8px!important;font-weight:850!important;}\n    @media(max-width:900px){[class*="st-key-qcms_login_shell"]{margin:1.2rem auto!important;padding:10px!important}.qcms-login-hero{min-height:auto;padding:24px}.qcms-login-title{font-size:27px}.qcms-login-feature-list{display:none}.qcms-login-badges{margin-bottom:4px}.qcms-login-version{margin-top:10px}}\n
