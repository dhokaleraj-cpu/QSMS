...
DEFINITIONS = (
    ...
    MasterDef(
        ...
        fields=(
            ...
            FieldDef("service_type", "Control type", kind="select", options=("CALIBRATION", "VALIDATION", "BOTH"), default="CALIBRATION", required=True),
            ...
            FieldDef("next_due_date", "Next calibration due date", kind="date"),
            FieldDef("validation_frequency_days", "Validation frequency (days)", kind="integer", default=365),
            FieldDef("last_validation_date", "Last validation date", kind="date"),
            FieldDef("next_validation_due_date", "Next validation due date", kind="date"),
            FieldDef("status", "Record status", kind="select", options=("ACTIVE", "INACTIVE", "BLOCKED"), default="ACTIVE", required=True),
            FieldDef("remarks", "Remarks", kind="textarea"),
        ),
        columns=("asset_code", "asset_name", "asset_type", "service_type", "location", "next_due_date", "next_validation_due_date", "status"),
