...
TENANT_SCOPED_TABLES = {
    ...
    "supply_customer_orders", "supply_rm_purchase_orders", "supply_rm_receipts", "supply_forging_orders", "supply_rm_dispatches", "supply_forging_receipts", "supply_downstream_events",
