...
def test_v41442_identity_and_no_schema_change():
    assert text("VERSION").strip() in {"4.14.42", "4.14.43", "4.14.44", "4.14.45", "4.14.46", "4.14.47", "4.14.48"}
    manifest = json.loads(text("DEPLOYMENT_MANIFEST.json"))
    assert manifest["version"] in {"4.14.42", "4.14.43", "4.14.44", "4.14.45", "4.14.46", "4.14.47", "4.14.48"}
    ...
    expected_previous = {"4.14.42": "4.14.41", "4.14.43": "4.14.42", "4.14.44": "4.14.43", "4.14.45": "4.14.44", "4.14.46": "4.14.45", "4.14.47": "4.14.46", "4.14.48": "4.14.47"}
