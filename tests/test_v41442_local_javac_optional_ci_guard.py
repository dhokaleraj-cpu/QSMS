...
def test_v41442_identity_and_no_schema_change():
    assert text("VERSION").strip() in {"4.14.42", "4.14.43", "4.14.44", "4.14.45", "4.14.46", "4.14.47", "4.14.48", "4.14.49"}
    manifest = json.loads(text("DEPLOYMENT_MANIFEST.json"))
    assert manifest["version"] in {"4.14.42", "4.14.43", "4.14.44", "4.14.45", "4.14.46", "4.14.47", "4.14.48", "4.14.49"}
    assert manifest["build"] in {"41442-LOCAL-JAVAC-OPTIONAL-CI-COMPILE-GUARD", "41443-ANDROID-STREAMLIT-SIDEBAR-NAV", "41444-ANDROID-NATIVE-MENU-SUBMENU-RESTORE", "41445-SHARED-RAW-SOURCE-LAYOUT-CONTROL", "41446-ANDROID-V12-DRAWER-PERSISTENT-AUTH", "41447-PO-WATERMARK-20-APPROVER-STAMP", "41448-PO-WATERMARK05-APPROVER-SESSION-STABILITY-ANDROID-EVERY-RELEASE", "41449-ANDROID-SINGLE-NATIVE-DRAWER-V12"}
    expected_previous = {"4.14.42": "4.14.41", "4.14.43": "4.14.42", "4.14.44": "4.14.43", "4.14.45": "4.14.44", "4.14.46": "4.14.45", "4.14.47": "4.14.46", "4.14.48": "4.14.47", "4.14.49": "4.14.48"}
