...
def test_v4118_release_and_global_build():
    assert (ROOT / "VERSION").read_text().strip() in {"4.11.8", "4.12.0", "4.12.1", "4.12.2", "4.12.3", "4.12.4", "4.12.5", "4.12.6", "4.12.7", "4.12.8", "4.12.9", "4.13.0", "4.13.1", "4.13.2", "4.13.3", "4.13.4", "4.13.5"}
