...
def test_release_identity_and_source_only_schema_baseline():
    assert text('VERSION').strip() in {'4.14.23','4.14.24','4.14.25','4.14.26','4.14.27','4.14.28','4.14.29','4.14.30','4.14.31'}
    manifest=json.loads(text('DEPLOYMENT_MANIFEST.json'))
    assert manifest['version'] in {'4.14.23','4.14.24','4.14.25','4.14.26','4.14.27','4.14.28','4.14.29','4.14.30','4.14.31'}
