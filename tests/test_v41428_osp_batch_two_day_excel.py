...
def test_v41428_release_identity_and_manifest():
    ...
    assert manifest['database_schema_required'] == ('4.14.36' if manifest['version'] in {'4.14.36','4.14.37', '4.14.38', '4.14.39', '4.14.40', '4.14.41', '4.14.42', '4.14.43', '4.14.44'} else ('4.14.35' if manifest['version'] == '4.14.35' else '4.14.28'))
