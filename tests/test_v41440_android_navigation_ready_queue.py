...
def test_android_v018_identity_and_footer_remains_removed():
    ...
    java = text("mobile/android_qcms/app/src/main/java/com/fourstar/qcms/MainActivity.java")
    assert any(v in gradle for v in ("versionCode 9", "versionCode 10", "versionCode 11", "versionCode 12", "versionCode 13"))
    assert any(v in gradle for v in ("versionName '0.1.8'", "versionName '0.1.9'", "versionName '0.2.0'", "versionName '0.2.1'", "versionName '0.2.2'"))
