...
def test_reminder_guard_mobile_collapse_icon_and_ios_package_are_present():
    ...
    assert ("QCMSMobile/0.1.3" in android or "QCMSMobile/0.1.4" in android or "QCMSMobile/0.1.5" in android or "QCMSMobile/0.1.6" in android or "QCMSMobile/0.1.7" in android or "QCMSMobile/0.1.8" in android)
