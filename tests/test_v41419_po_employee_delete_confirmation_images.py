...
def test_release_identity_and_manifest():
    assert (ROOT / "VERSION").read_text().strip() in {"4.14.19","4.14.20", "4.14.21", "4.14.22", "4.14.23", "4.14.24", "4.14.25", "4.14.26"}
    manifest = text("DEPLOYMENT_MANIFEST.json")
    app = text("streamlit_app.py")
    assert any(v in manifest for v in ('"version": "4.14.19"','"version": "4.14.20"','"version": "4.14.21"','"version": "4.14.22"','"version": "4.14.23"', '"version": "4.14.24"', '"version": "4.14.25"', '"version": "4.14.26"'))
