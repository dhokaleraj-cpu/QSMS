...
def test_v41431_release_identity_and_source_only_schema_contract():
    assert text("VERSION").strip() in {"4.14.31", "4.14.32", "4.14.33", "4.14.34", "4.14.35", "4.14.36", "4.14.37", "4.14.38"}
    ...
    assert manifest["version"] in {"4.14.31", "4.14.32", "4.14.33", "4.14.34", "4.14.35", "4.14.36", "4.14.37", "4.14.38"}
...
def test_controlled_po_pdf_prints_customer_source_reference_table():
    ...
    if text("VERSION").strip() in {"4.14.35", "4.14.36", "4.14.37", "4.14.38"}:
...
def test_v41431_online_verification_knows_new_po_release():
    ...
    assert ("41431-PO-WORKSPACE-PREAPPROVAL-EDIT-CUSTOMER-REF-PDF" in phase) or ("41432-PO-PRINT-COMPACT-RM-TYPES-ANDROID-TEST" in phase) or ("41433-PO-PORTRAIT-TERMS-BATCH-PRINT-EMAIL-ANDROID-SDK" in phase) or (("41434-INDIVIDUAL-PO-PDF-ZIP-ANDROID-APK-BUILD" in phase) or ("41435-PO-WATERMARK-REMINDER-MOBILE-IOS" in phase) or ("41436-COMPLAINT-EMAIL-REGISTERS-REMINDERS-MOBILE-DRAWER" in phase) or ("41437-MOBILE-FULL-NAV-COMPLAINT-CARDS-PO-APPROVAL-DRAFT-EMAIL" in phase) or ("41438-ANDROID-NAV-SESSION-BRIDGE-FOOTER-REMOVE" in phase))
