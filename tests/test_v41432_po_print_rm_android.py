...
def test_v41432_release_identity_and_source_only_schema():
    ...
    assert version in {"4.14.32", "4.14.33", "4.14.34", "4.14.35", "4.14.36", "4.14.37"}
    ...
    if version in {"4.14.35", "4.14.36", "4.14.37"}:
        assert manifest["database_schema_required"] == ("4.14.36" if version == "4.14.37" else version)
...
def test_android_test_shell_and_samsung_install_helper_are_packaged():
    ...
    assert "https://" in activity and ("QCMSMobile/0.1.0" in activity or "QCMSMobile/0.1.1" in activity or "QCMSMobile/0.1.2" in activity or "QCMSMobile/0.1.3" in activity or "QCMSMobile/0.1.4" in activity or "QCMSMobile/0.1.5" in activity)
