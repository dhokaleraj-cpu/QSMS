...
def test_version_build_manifest_and_release_docs_are_v41418():
    ...
    assert text("VERSION").strip() in {"4.14.18", "4.14.19", "4.14.20", "4.14.21", "4.14.22", "4.14.23", "4.14.23", "4.14.24", "4.14.25"}
    ...
    assert any(marker in app for marker in (
        ...
        "41424-PO-TECH-GRID-LIVE-IMPORT-APQP-DATE", "41425-PO-EDIT-MASTER-STATE-TRANSACTION-EDIT-PERFORMANCE",
    ))
    manifest = json.loads(text("DEPLOYMENT_MANIFEST.json"))
    assert manifest["version"] in {"4.14.18", "4.14.19", "4.14.20", "4.14.21", "4.14.22", "4.14.23", "4.14.23", "4.14.24", "4.14.25"}
