...
def test_android_v019_identity_and_prior_navigation_fixes_preserved():
    ...
    java = text("mobile/android_qcms/app/src/main/java/com/fourstar/qcms/MainActivity.java")
    assert any(v in gradle for v in ("versionCode 10", "versionCode 11", "versionCode 12", "versionCode 13"))
    assert any(v in gradle for v in ("versionName '0.1.9'", "versionName '0.2.0'", "versionName '0.2.1'", "versionName '0.2.2'"))
