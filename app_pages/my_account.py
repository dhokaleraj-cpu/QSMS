...
def render() -> None:
    ...
    section_bar("CHANGE LOGIN PASSWORD", "Available to every signed-in QCMS user. Your current password is verified before the change is accepted.")
