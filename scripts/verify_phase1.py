...
if current_release_version != "4.14.43" or current_release_build != "41443-ANDROID-STREAMLIT-SIDEBAR-NAV":
    errors.append("v4.14.43 deployment manifest release identity is incomplete")
...
if not all(token in v41436_android for token in ("openDrawer", "closeDrawer", "global-search", "complaints-home", "stawn_icon")) or not any(v in v41436_android for v in ("QCMSMobile/0.1.4", "QCMSMobile/0.1.5", "QCMSMobile/0.1.6", "QCMSMobile/0.1.7", "QCMSMobile/0.1.8", "QCMSMobile/0.1.9", "QCMSMobile/0.2.0")):
...
if not all(token in v41436_android for token in ("drawerSection", "drawerChildButton", "Approval / Confirmation", "Customer Register", "Supplier Register", "native_mobile")) or not any(v in v41436_android for v in ("QCMSMobile/0.1.5", "QCMSMobile/0.1.6", "QCMSMobile/0.1.7", "QCMSMobile/0.1.8", "QCMSMobile/0.1.9", "QCMSMobile/0.2.0")):
...
# v4.14.43 stable Android navigation: Streamlit sidebar, full-screen WebView.
v41443_test = (ROOT / "tests" / "test_v41443_android_streamlit_sidebar_nav.py").read_text(encoding="utf-8")
if not all(token in v41436_android for token in ("USE_STREAMLIT_WEB_NAV = true", "showStableStreamlitBrowser", "QCMSMobile/0.2.0", 'appendQueryParameter("native_nav","streamlit")')):
    errors.append("v4.14.43 Android full-screen Streamlit navigation wrapper is incomplete")
if not all(token in v41437_streamlit for token in ("android_streamlit_nav", 'st.navigation(_mobile_page_groups, position="sidebar", expanded=False)', "elif android_streamlit_nav:")):
    errors.append("v4.14.43 Streamlit-owned Android sidebar navigation is incomplete")
if not all(token in v41443_test for token in ("test_android_stable_mode_is_fullscreen_webview", "test_streamlit_owns_android_page_navigation", "test_android_release_identity_is_v020")):
    errors.append("v4.14.43 focused Android sidebar-navigation regression tests are incomplete")

report = {
    "release": "QCMS 4.14.43 Android Streamlit Sidebar Navigation",
    "v41443_android_fullscreen_streamlit_nav": all(token in v41436_android for token in ("USE_STREAMLIT_WEB_NAV = true", "showStableStreamlitBrowser", "QCMSMobile/0.2.0", 'appendQueryParameter("native_nav","streamlit")')),
    "v41443_streamlit_sidebar_router": all(token in v41437_streamlit for token in ("android_streamlit_nav", 'st.navigation(_mobile_page_groups, position="sidebar", expanded=False)', "elif android_streamlit_nav:")),
    ...
    "v41438_android_session_safe_nav": any(v in v41436_android for v in ("QCMSMobile/0.1.9", "QCMSMobile/0.2.0")) and "__qcmsNativeNavigate" in v41436_android and "webView.loadUrl(nativeUrl(path))" not in v41436_android,
    ...
    "v41437_android_full_nav": any(v in v41436_android for v in ("QCMSMobile/0.1.5", "QCMSMobile/0.1.6", "QCMSMobile/0.1.7", "QCMSMobile/0.1.8", "QCMSMobile/0.1.9", "QCMSMobile/0.2.0")) and "drawerSection" in v41436_android,
    ...
    "v41436_android_native_ui": any(v in v41436_android for v in ("QCMSMobile/0.1.4", "QCMSMobile/0.1.5", "QCMSMobile/0.1.6", "QCMSMobile/0.1.7", "QCMSMobile/0.1.8", "QCMSMobile/0.1.9", "QCMSMobile/0.2.0")) and "openDrawer" in v41436_android,
    ...
    "v41431_source_only_schema": (current_release_version in ("4.14.35", "4.14.36", "4.14.37", "4.14.38", "4.14.39", "4.14.40", "4.14.41", "4.14.42", "4.14.43")) or (str(v41429_manifest.get("database_schema_required")) == "4.14.28" and not bool(v41429_manifest.get("database_migration_required"))),
    ...
    "v41430_source_only_schema": (current_release_version in ("4.14.35", "4.14.36", "4.14.37", "4.14.38", "4.14.39", "4.14.40", "4.14.41", "4.14.42", "4.14.43")) or (str(v41429_manifest.get("database_schema_required")) == "4.14.28" and not bool(v41429_manifest.get("database_migration_required"))),
    ...
    "v41429_source_only_schema": (current_release_version in ("4.14.35", "4.14.36", "4.14.37", "4.14.38", "4.14.39", "4.14.40", "4.14.41", "4.14.42", "4.14.43")) or (str(v41429_manifest.get("database_schema_required")) == "4.14.28" and not bool(v41429_manifest.get("database_migration_required"))),
